...
<h2>TOP CLIENT IP ADDRESS</h2>
<%

Connection con = Database.dataConnection();		
String str = "select IP,count(*) as topic from log_1 group by IP order by count(*) desc limit 5";
String str1 = "select IP,count(*) as topic from log_2 group by IP order by count(*) desc limit 5";
