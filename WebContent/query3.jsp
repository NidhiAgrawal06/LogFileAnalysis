...
<h2>TOP URL BY SIZE OF RESPONSE</h2>
<%

Connection con = Database.dataConnection();		
String str = "select Request,Size from log_1 group by Request order by cast(Size as signed) desc limit 5";
String str1 = "select URL,Size from log_2 where URL <>'-' group by URL order by cast(Size as signed) desc limit 5";
